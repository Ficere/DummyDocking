...
class FTAtomsNode(_FTAddChild, CPP.FTAtomsNode):
    pass


class FTBase(_FTAddChild, CPP.FTBase):
    pass
...
class FTDiscreteConformation(_FTAddChild, CPP.FTDiscreteConformation):
    pass


class FTDiscreteTransformation(_FTAddChild, CPP.FTDiscreteTransformation):
    pass


class FTDiscreteTranslation(_FTAddChild, CPP.FTDiscreteTranslation):
    pass


class FTRotationAboutBond(_FTAddChild, CPP.FTRotationAboutBond):
    pass


class FTRotationAboutPointQuat(_FTAddChild, CPP.FTRotationAboutPointQuat):
    pass
...
class FTTorsion(_FTAddChild, CPP.FTTorsion):
    def setDihedralAtomIndexes(
        ...
        self._declaredAtomSet = aAtomSet
        super(FTTorsion, self).setDihedralAtomIndexes(
            aAtomIndex1, aAtomIndex2, aAtomIndex3, aAtomIndex4, aAtomSet
        )
