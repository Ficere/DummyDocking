...
class MathTable(_object):
    ...
    def calcFuncDx(self, x, xdx):
        return _adfrcc.MathTable_calcFuncDx(self, x, xdx)
...
class Parameters(_object):
    ...
    def setHbondMode(self, mode):
        return _adfrcc.Parameters_setHbondMode(self, mode)
    ...
    def getHbondMode(self):
        return _adfrcc.Parameters_getHbondMode(self)
...
class AtomSet(NamedObject):
    ...
    def resetForces(self):
        return _adfrcc.AtomSet_resetForces(self)
...
class RigidReceptorScorer(Scorer):
    ...
    def scoreLRR(self, value):
        return _adfrcc.RigidReceptorScorer_scoreLRR(self, value)

    def scoreLL(self, value):
        return _adfrcc.RigidReceptorScorer_scoreLL(self, value)
...
class FTBase(NamedObject):
    ...
    def getBoundsMin(self):
        return _adfrcc.FTBase_getBoundsMin(self)

    def getBoundsMax(self):
        return _adfrcc.FTBase_getBoundsMax(self)
    ...
    def forcesToGeneGradients(self, indopt, atomSet, offset, grad):
        return _adfrcc.FTBase_forcesToGeneGradients(self, indopt, atomSet, offset, grad)
    ...
    def getBFGSboundsMax(self, dest):
        return _adfrcc.FTBase_getBFGSboundsMax(self, dest)
...
class FTAtomsNode(FTBase):
    ...
    def getAtomIndexesPyC(self):
        return _adfrcc.FTAtomsNode_getAtomIndexesPyC(self)

    def getAtomIndexesPyCCopy(self, buffer):
        return _adfrcc.FTAtomsNode_getAtomIndexesPyCCopy(self, buffer)
...
class FTRotationAboutPointQuat(FTBase):
    ...
    def getRotPointC(self):
        return _adfrcc.FTRotationAboutPointQuat_getRotPointC(self)
...
class FTTorsion(FTBase):
    ...
    def getAffectedAtomIndexesC(self):
        return _adfrcc.FTTorsion_getAffectedAtomIndexesC(self)

    def getAffectedAtomIndexesCCopy(self, buffer):
        return _adfrcc.FTTorsion_getAffectedAtomIndexesCCopy(self, buffer)
    ...
    def getBFGSboundsMax(self, dest):
        return _adfrcc.FTTorsion_getBFGSboundsMax(self, dest)
...
class Genome(_object):
    ...
    def setRamaTorsions(self, values):
        return _adfrcc.Genome_setRamaTorsions(self, values)

    def calculateRamachandraScore(self, variables, dphi, dpsi):
        return _adfrcc.Genome_calculateRamachandraScore(self, variables, dphi, dpsi)
...
class Individual(_object):
    ...
    if _newclass:
        dphi = _swig_property(_adfrcc.Individual_dphi_get, _adfrcc.Individual_dphi_set)
    __swig_setmethods__["dpsi"] = _adfrcc.Individual_dpsi_set
...
class BFGSQuat(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, BFGSQuat, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, BFGSQuat, name)
    __repr__ = _swig_repr
    __swig_getmethods__["getSingleton"] = lambda x: _adfrcc.BFGSQuat_getSingleton
    if _newclass:
        getSingleton = staticmethod(_adfrcc.BFGSQuat_getSingleton)

    def __init__(self, individual):
        this = _adfrcc.new_BFGSQuat(individual)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def setMaxSteps(self, aMaxSteps):
        return _adfrcc.BFGSQuat_setMaxSteps(self, aMaxSteps)
