...
class FetchGUI(QtGui.QDialog):
    ...
    def __init__(self, parent=None, formats=["pdb", "mmtf"]):
        ...
        self.searchButton.setSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        ...
        layout.setFieldGrowthPolicy(QtGui.QFormLayout.FieldGrowthPolicy.ExpandingFieldsGrow )#(2|1))
...
<accessionIdList>%s</accessionIdList>
    ...
    def __init__(self, title, keyword=None, parent=None):
        ...
        self.toggleSelectAllB.setSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
