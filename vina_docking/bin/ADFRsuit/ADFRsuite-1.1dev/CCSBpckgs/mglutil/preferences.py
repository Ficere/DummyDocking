...
class UserPreference(UserDict):
    ...
    def add(self, name, value, defaultValue=None, validValues=[], validateFunc=None,
            callbackFunc=[], doc='', category="General", parent=None):
...
#            return
    ...
    def addItem(self, prefItem, overwrite=False):
        if self.has_key(prefItem.name) and not overwrite:
            return
        self.add(prefItem.name, prefItem.currValue,  prefItem.defaultVal,
                 prefItem.validValues, prefItem.validateFunc, prefItem.callbackFunc,
                 prefItem.docStr, prefItem.category, prefItem.parent)
...
class PreferenceItem:
    ...
    def __init__(self, name, value, defaultVal=None, validValues=[], validateFunc=None,
                 callbackFunc=[], doc='', category="General", parent=None):
        self.name = name
