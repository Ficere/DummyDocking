...
APP.addArgument("msa", help="MSA filename to be filtered")

APP.addArgument("word", help="word to be compared to sequence label", nargs="+")
...
def evol_filter(msa, *word, **kwargs):
    ...
    if kwargs.get("startswith", False):
        ...
        raise TypeError(
            "one of startswith, endswith, contains, or equals " "must be specified"
        )
