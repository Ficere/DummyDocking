...
for key, txt, val in [
    ...
    ("select", "atom selection", "protein and name CA or nucleic and name P C4' C2"),
    ...
    (
        "extend",
        "write NMD file for the model extended to "
    ...
    ("figwidth", "figure width (inch)", 8.0),
    ("figheight", "figure height (inch)", 6.0),
...
def addNMAOutput(parser):
    ...
    parser.add_argument(
        ...
        dest="outall",
        action="store_true",
        default=DEFAULTS["outall"],
        help=HELPTEXT["outall"],
    )
    ...
    parser.add_argument(
        ...
        dest="outeig",
        action="store_true",
        default=DEFAULTS["outeig"],
        help=HELPTEXT["outeig"],
    )
    ...
    parser.add_argument(
        ...
        dest="outcov",
        action="store_true",
        default=DEFAULTS["outcov"],
        help=HELPTEXT["outcov"],
    )
    ...
    parser.add_argument(
        ...
        dest="outnpz",
        action="store_true",
        default=DEFAULTS["outnpz"],
        help=HELPTEXT["outnpz"],
    )
...
def addNMAFigures(parser):
    ...
    parser.add_argument(
        ...
        dest="figall",
        action="store_true",
        default=DEFAULTS["figall"],
        help=HELPTEXT["figall"],
    )

    parser.add_argument(
        "-R",
        "--cross-correlations-figure",
        dest="figcc",
        action="store_true",
        default=DEFAULTS["figcc"],
        help=HELPTEXT["figcc"],
    )

    parser.add_argument(
        "-Q",
        "--square-fluctuations-figure",
        dest="figsf",
        action="store_true",
        default=DEFAULTS["figsf"],
        help=HELPTEXT["figsf"],
    )
