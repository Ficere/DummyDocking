        ...
        try:
            ...
            if figall or bf:
                ...
                plt.plot(
                    bcal,
                    label=(
                        "Theoretical (corr coef = {0:.2f})".format(
...
def addCommand(commands):
    subparser = commands.add_parser(
        "gnm", help="perform Gaussian network model calculations"
    )
    ...
    subparser.set_defaults(
        usage_example="""This command performs GNM calculations for given PDB structure and \
...
save all of the graphical output files:
  ...
  $ prody gnm 1aar -c 7 -s "calpha and chain A and resnum < 70" -A""",
    ...
    group.add_argument(
        ...
        dest="figmode",
        type=str,
        default=DEFAULTS["figmode"],
        help=HELPTEXT["figmode"],
        metavar="STR",
    )
    ...
    subparser.set_defaults(
        func=lambda ns: prody_gnm(ns.__dict__.pop("pdb"), **ns.__dict__)
    )
