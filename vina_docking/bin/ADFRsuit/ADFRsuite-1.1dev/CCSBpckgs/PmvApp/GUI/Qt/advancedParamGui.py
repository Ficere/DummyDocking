...
class ColorsWidget(QtGui.QWidget):
    ...
    def custom_cb(self):
        ...
        #colorDialog.setOption(QtGui.QColorDialog.DontUseNativeDialog)
        ...
        colorDialog.setAttribute(QtCore.Qt.WA_DeleteOnClose)
        self.savedColors = []
        #colorDialog.open()
        colorDialog.exec_()
...
class SBCustomizeWidget(IndexedGeomCustomizeWidget):
    ...
    def showSticksCustomColorDialog_cb(self):
        ...
        colorDialog.setAttribute(QtCore.Qt.WA_DeleteOnClose) # this fixes a bug in MacOSx native color dialog, when it adds another row of "OK-Cancel" buttons each time the dialog opens in modal mode.
        colorDialog.exec_()
...
class CustomizeRepresentationsDialog(QtGui.QDialog):
    ...
    def updateGUI(self, selSet, selName, title=None):
        self.selSet=selSet
