...
def getGUI(GUITK):
    if GUITK == "Tk":
        from guiTK.selectionCmds import (
            MVClearSelectionGUI,
            MVSelectSetCommandGUI,
            MVSelectFromStringCommandGUI,
            MVDirectSelectCommandGUI,
            MVSelectSphericalRegionGUI,
            MVInvertSelectionGUI,
            MVSelectNoWaterHeteroAtomsCommandGUI,
            MVSaveSetCommandGUI,
        )
