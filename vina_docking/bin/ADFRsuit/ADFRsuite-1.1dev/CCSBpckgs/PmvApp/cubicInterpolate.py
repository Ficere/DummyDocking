...
def CubicInterpolate(p0, p1, p2, p3, t):
    ...
    a1 = [p0[0] - p1[0] - a0[0], p0[1] - p1[1] - a0[1], p0[2] - p1[2] - a0[2]]
    a2 = [p2[0] - p0[0], p2[1] - p0[1], p2[2] - p0[2]]

    return [
        a0[0] * t * t2 + a1[0] * t2 + a2[0] * t + p1[0],
...
def GetFrames(path):
    ...
    binormals = binormals / numpy.linalg.norm(binormals, axis=1).reshape(
        (len(binormals), 1)
    )
