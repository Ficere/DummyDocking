...
def getGUI(GUITK):
    if GUITK == "Tk":
        from guiTK.secondaryStructureCmds import (
            ComputeSecondaryStructureCommandGUI,
            ExtrudeSecondaryStructureCommandGUI,
            ExtrudeSecondaryStructureCommandUnicGUI,
            RibbonCommandGUI,
            ColorBySSElementTypeGUI,
            DisplayExtrudedSSCommandGUI,
        )
        ...
        return {
            "computeSecondaryStructure": [(None, (), {})],
