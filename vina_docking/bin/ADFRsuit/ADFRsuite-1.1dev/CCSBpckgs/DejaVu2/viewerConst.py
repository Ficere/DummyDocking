...
LINES_PRIMITIVES = (GL.GL_LINES, GL.GL_LINE_LOOP, GL.GL_LINE_STRIP)
POLYGON_PRIMITIVES = (
    GL.GL_TRIANGLES,
...
MINIMUM_LENGTH = {
    ...
    GL.GL_LINE_STRIP: 3,
    GL.GL_TRIANGLES: 3,
    GL.GL_TRIANGLE_STRIP: 4,
    GL.GL_TRIANGLE_FAN: 4,
    GL.GL_QUADS: 4,
    GL.GL_QUAD_STRIP: 5,
    GL.GL_POLYGON: 3,
}
...
CULLINGS_values = (GL.GL_NONE, GL.GL_BACK, GL.GL_FRONT, GL.GL_FRONT_AND_BACK, INHERIT)
