...
from actor import (
    DejaVu2Actor,
    DejaVu2MaterialActor,
    DejaVu2ScissorActor,
    DejaVu2ClipZActor,
    DejaVu2FogActor,
    DejaVu2LightColorActor,
    DejaVu2SpheresRadiiActor,
    DejaVu2RotationActor,
    DejaVu2ConcatRotationActor,
    DejaVu2GeomVisibilityActor,
    DejaVu2TransformationActor,
    DejaVu2GeomEnableClipPlaneActor,
    DejaVu2CameraActor,
)
...
actorsDescr = {
    Transformable: {
        "rotation": {"actor": (DejaVu2RotationActor, (), {})},
        "concatRotation": {"actor": (DejaVu2ConcatRotationActor, (), {})},
        "translation": {
            "actor": (
                DejaVu2Actor,
                (),
        ...
        "transformation": {"actor": (DejaVu2TransformationActor, (), {})},
    },
    Displayable: {
        "colors": {
            "actor": (
                ...
                (),
                {
                    ...
                    "getFunction": (
                        lambda x, y: numpy.copy(x.materials[y].prop[1][:, :3]),
                        (GL.GL_FRONT,),
                        {},
                    ),
