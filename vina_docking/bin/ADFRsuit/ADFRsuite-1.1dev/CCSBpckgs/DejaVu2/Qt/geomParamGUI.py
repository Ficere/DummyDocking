...
class BondOrderWidgets(QtGui.QWidget):
    ...
    def __init__(
        ...
        parent=None,
        labels={
            "db": "double bond separation:",
            "tb": "triple bond separation:",
            "aromatic": "aromatic line width:",
        },
        values={
            "db": (0.12, [0.1, 10.0]),
            "tb": (0.2, [0.1, 10.0]),
...
class StrokeWidgets(QtGui.QWidget):
    ...
    def addWidgets(self):
        ...
        self.connect(
            custom, QtCore.SIGNAL("triggered()"), self.showCustomColorDialog_cb
        )
    ...
    def showCustomColorDialog_cb(self):
        ...
        )  # this fixes a bug in MacOSx native color dialog, when it adds another row of "OK-Cancel" buttons each time the dialog opens in modal mode.
        colorDialog.exec_()
    ...
    def colorDialogClosed_cb(self, val):
        ...
        if val == 0:
            ...
            self.backFaceColorChanged.emit(0.0, 0.0, 0.0, 0.0, False, True)
...
class SBModelGlobalParams(QtGui.QWidget):
    ...
    def addWidgets(self):
        ...
        bolabels = {
            "db": "double bond separation:",
            "tb": "triple bond separation:",
            "aromatic": "aromatic sphere rad:",
        }
        vals = {
            "db": ("auto", [0.01, 10.0]),
            "tb": ("auto", [0.01, 10.0]),
            "aromatic": (0.15, [0.0, 10.0]),
        }
...
class MsmsSurfaceParams(QtGui.QWidget):
    ...
    def addWidgets(self):
        ...
        self.probeRadBox.setRange(0.0, 10.0)
