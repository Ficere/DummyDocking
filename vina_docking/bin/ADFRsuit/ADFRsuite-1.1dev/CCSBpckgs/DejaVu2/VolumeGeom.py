...
class CropBox:
    ...
    def update(self):
        ...
        self.crop.SetSlabs(
            max(0, self.xmin),
            min(self.xmax, self.volSize[0]),
            max(0, self.ymin),
            min(self.ymax, self.volSize[1]),
            max(0, self.zmin),
            min(self.zmax, self.volSize[2]),
        )
