...
bondAngles = {
    "HW-OW-HW": [100.0, 104.52, "TIP3P water"],
    "HW-HW-OW": [0.0, 127.74, "(found in crystallographic water with 3 bonds)"],
...
dihedTypes = {
    "X -C -CA-X ": [[4, 14.50, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -C -CB-X ": [[4, 12.00, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -C -CM-X ": [[4, 8.70, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -C -N*-X ": [[4, 5.80, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -C -NA-X ": [[4, 5.40, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -C -NC-X ": [[2, 8.00, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -C -OH-X ": [[2, 1.80, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -C -CT-X ": [[4, 0.00, 0.0, 2.0, "JCC,7,(1986),230"]],
    "X -CA-CA-X ": [[4, 14.50, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CA-CB-X ": [[4, 14.00, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CA-CM-X ": [[4, 10.20, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CA-CT-X ": [[6, 0.00, 0.0, 2.0, "JCC,7,(1986),230"]],
    "X -CA-N2-X ": [[4, 9.60, 180.0, 2.0, "reinterpolated 93'"]],
    "X -CA-NA-X ": [[4, 6.00, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CA-NC-X ": [[2, 9.60, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CB-CB-X ": [[4, 21.80, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CB-N*-X ": [[4, 6.60, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CB-NB-X ": [[2, 5.10, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CB-NC-X ": [[2, 8.30, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CK-N*-X ": [[4, 6.80, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CK-NB-X ": [[2, 20.00, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CM-CM-X ": [[4, 26.60, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CM-CT-X ": [[6, 0.00, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -CM-N*-X ": [[4, 7.40, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CQ-NC-X ": [[2, 13.60, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CT-CT-X ": [[9, 1.40, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -CT-N -X ": [[6, 0.00, 0.0, 2.0, "JCC,7,(1986),230"]],
    "X -CT-N*-X ": [[6, 0.00, 0.0, 2.0, "JCC,7,(1986),230"]],
    "X -CT-N2-X ": [[6, 0.00, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -CT-OH-X ": [[3, 0.50, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -CT-OS-X ": [[3, 1.15, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -OH-P -X ": [[3, 0.75, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -OS-P -X ": [[3, 0.75, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -C -N -X ": [[4, 10.00, 180.0, 2.0, "AA|check Wendy?&NMA"]],
    "X -CT-N3-X ": [[9, 1.40, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -CT-S -X ": [[3, 1.00, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -CT-SH-X ": [[3, 0.75, 0.0, 3.0, "JCC,7,(1986),230"]],
    "X -C*-CB-X ": [[4, 6.70, 180.0, 2.0, "intrpol.bsd.onC6H6aa"]],
    "X -C*-CT-X ": [[6, 0.00, 0.0, 2.0, "JCC,7,(1986),230"]],
    "X -C*-CW-X ": [[4, 26.10, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CA-CN-X ": [[4, 14.50, 180.0, 2.0, "reinterpolated 93'"]],
    "X -CB-CN-X ": [[4, 12.00, 180.0, 2.0, "reinterpolated 93'"]],
    "X -CC-CT-X ": [[6, 0.00, 0.0, 2.0, "JCC,7,(1986),230"]],
    "X -CC-CV-X ": [[4, 20.60, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CC-CW-X ": [[4, 21.50, 180.0, 2.0, "intrpol.bsd.on C6H6"]],
    "X -CC-NA-X ": [[4, 5.60, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CC-NB-X ": [[2, 4.80, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CN-NA-X ": [[4, 6.10, 180.0, 2.0, "reinterpolated 93'"]],
    "X -CR-NA-X ": [[4, 9.30, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CR-NB-X ": [[2, 10.00, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CV-NB-X ": [[2, 4.80, 180.0, 2.0, "JCC,7,(1986),230"]],
    "X -CW-NA-X ": [[4, 6.00, 180.0, 2.0, "JCC,7,(1986),230"]],
    "CT-CT-OS-CT": [[1, 0.383, 0.0, -3.0, ""], [1, 0.1, 180.0, 2.0, ""]],
    "C -N -CT-C ": [[1, 0.20, 180.0, 2.0, ""]],
    "N -CT-C -N ": [
        [1, 0.40, 180.0, -4.0, ""],
        [1, 1.35, 180.0, -2.0, ""],
        [1, 0.75, 180.0, 1.0, ""],
    ...
    "CT-CT-C -N ": [[1, 0.100, 0.0, -4.0, ""], [1, 0.07, 0.0, 2.0, ""]],
    "H -N -C -O ": [
        [1, 2.50, 180.0, -2.0, "JCC,7,(1986),230"],
        [1, 2.00, 0.0, 1.0, "J.C.cistrans-NMA DE"],
    ],
    "CT-S -S -CT": [
        [1, 3.50, 0.0, -2.0, "JCC,7,(1986),230"],
        [1, 0.60, 0.0, 3.0, "JCC,7,(1986),230"],
    ],
    "OS-CT-CT-OS": [
        [1, 0.144, 0.0, -3.0, "JCC,7,(1986),230"],
        [1, 1.00, 0.0, 2.0, "pucker anal (93')"],
    ],
    "OS-CT-CT-OH": [
        [1, 0.144, 0.0, -3.0, "JCC,7,(1986),230"],
        [1, 1.00, 0.0, 2.0, "pucker anal (93')"],
    ...
    "OH-CT-CT-OH": [
        [1, 0.144, 0.0, -3.0, "JCC,7,(1986),230"],
        [1, 1.00, 0.0, 2.0, "check glicolWC? puc"],
    ],
    "OH-P -OS-CT": [
        [1, 0.25, 0.0, -3.0, "JCC,7,(1986),230"],
        [1, 1.20, 0.0, 2.0, "gg&gt ene.631g*/mp2"],
    ],
    "OS-P -OS-CT": [
        [1, 0.25, 0.0, -3.0, "JCC,7,(1986),230"],
        [1, 1.20, 0.0, 2.0, "gg&gt ene.631g*/mp2"],
    ...
    "OS-CT-N*-CK": [
        [1, 0.50, 180.0, -2.0, "sugar frag calc (PC)"],
        [1, 2.50, 0.0, 1.0, "sugar frag calc (PC)"],
    ],
    "OS-CT-N*-CM": [
        [1, 0.50, 180.0, -2.0, "sugar frag calc (PC)"],
        [1, 2.50, 0.0, 1.0, "sugar frag calc (PC)"],
...
improperDihed = {
    "X -X -C -O ": [10.5, 180.0, 2.0, "JCC,7,(1986),230"],
    "X -O2-C -O2": [10.5, 180.0, 2.0, "JCC,7,(1986),230"],
    "X -X -N -H ": [1.0, 180.0, 2.0, "JCC,7,(1986),230"],
    "X -X -N2-H ": [1.0, 180.0, 2.0, "JCC,7,(1986),230"],
    "X -X -NA-H ": [1.0, 180.0, 2.0, "JCC,7,(1986),230"],
    "X -N2-CA-N2": [10.5, 180.0, 2.0, "JCC,7,(1986),230"],
    "X -CT-N -CT": [1.0, 180.0, 2.0, "JCC,7,(1986),230"],
    "X -X -CA-HA": [1.1, 180.0, 2.0, "bsd.on C6H6 nmodes"],
    "X -X -CW-H4": [1.1, 180.0, 2.0, ""],
    "X -X -CR-H5": [1.1, 180.0, 2.0, ""],
    "X -X -CV-H4": [1.1, 180.0, 2.0, ""],
    "X -X -CQ-H5": [1.1, 180.0, 2.0, ""],
    "X -X -CK-H5": [1.1, 180.0, 2.0, ""],
    "X -X -CM-H4": [1.1, 180.0, 2.0, ""],
    "X -X -CM-HA": [1.1, 180.0, 2.0, ""],
    "X -X -CA-H4": [1.1, 180.0, 2.0, "bsd.on C6H6 nmodes "],
    "X -X -CA-H5": [1.1, 180.0, 2.0, "bsd.on C6H6 nmodes"],
    "CK-CB-N*-CT": [1.0, 180.0, 2.0, ""],
    "CM-C -N*-CT": [1.0, 180.0, 2.0, "dac guess, 9/94"],
    "CM-C -CM-CT": [1.1, 180.0, 2.0, ""],
    "CT-O -C -OH": [10.5, 180.0, 2.0, ""],
    "NA-CV-CC-CT": [1.1, 180.0, 2.0, ""],
    "NB-CW-CC-CT": [1.1, 180.0, 2.0, ""],
    "NA-CW-CC-CT": [1.1, 180.0, 2.0, ""],
    "CW-CB-C*-CT": [1.1, 180.0, 2.0, ""],
    "CA-CA-CA-CT": [1.1, 180.0, 2.0, ""],
    "C -CM-CM-CT": [1.1, 180.0, 2.0, "dac guess, 9/94"],
    "NC-CM-CA-N2": [1.1, 180.0, 2.0, "dac guess, 9/94"],
    "CB-NC-CA-N2": [1.1, 180.0, 2.0, "dac, 10/94"],
    "NA-NC-CA-N2": [1.1, 180.0, 2.0, "dac, 10/94"],
    "CA-CA-C -OH": [1.1, 180.0, 2.0, ""],
}
