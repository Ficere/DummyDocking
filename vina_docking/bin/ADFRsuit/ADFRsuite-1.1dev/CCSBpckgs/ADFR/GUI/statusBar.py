...
class MyStatusBar(QtGui.QStatusBar):
    ...
    def __init__(self, parent=None):
        ...
        self._infoPixmap = QtGui.QStyle.SP_MessageBoxInformation
        self._helpPixmap = QtGui.QStyle.SP_DialogHelpButton
        ...
        self._levelIcons["info"] = self._nothingPixmap
        self._levelIcons["help"] = self._nothingPixmap
...
if __name__ == "__main__":
    ...
    app.addLibraryPath(
        qtpath
    )  #'/mgl/ms1/people/sanner/python/mglTools2/MGLTools2-1.1/plugins')
    bar = MyStatusBar()
